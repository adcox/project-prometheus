 ...
 *
 * This has motherships, alkesh, and cargo ships; organized in rows
 */
public class Goauld_Mixed_3 extends Level {
    
    public Goauld_Mixed_3(){
        name = "Gross Group";
    ...
    public ArrayList<Ship> initShips(){
        ...
        for(int row = 0; row < (numRows); row++){
            for(int collum = 0; collum < (numCollumns); collum++){
                ...
                ships.add(new Ship_Goauld(4 - row, location, (stepX*3)/5, initX_Vel, firingProbibility, row, collum));
            }
        }

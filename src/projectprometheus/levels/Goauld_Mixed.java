 ...
 *
 * This level has a random assortment of all the Goa'uld ships
 */
public class Goauld_Mixed extends Level {
    ...
    public ArrayList<Ship> initShips(){
        ...
        for(int row = 0; row < (numRows); row++){
            for(int collum = 0; collum < (numCollumns); collum++){
                ...
                shipType = randy.nextInt(4) + 1;
                ships.add(new Ship_Goauld(shipType, location, (stepX*3)/5, initX_Vel, firingProbibility, row, collum));
            }
        }

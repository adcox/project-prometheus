 ...
 *
 * This has all types of replicator ships; organized in collumns
 */
public class Replicator_Mixed_5 extends Level {

    public Replicator_Mixed_5(){
        name = "Munching Machines";
    ...
    public ArrayList<Ship> initShips(){
        ...
        for(int row = 0; row < (numRows); row++){
            for(int collum = 0; collum < (numCollumns); collum++){
                ...
                ships.add(new Ship_Replicator((collum+2)%3 + 1, location, (stepX*3)/5, initX_Vel, firingProbibility, row, collum));
            }
        }

 ...
 * @version May 23, 2010
 *
 * This is all three types of ships, arranged in diagonal lines
 */
public class Ori_Mixed_4 extends Level {

    public Ori_Mixed_4(){
        name = "Worrysome Worshipers";
        race = RaceName.ORI;
        numCollumns = 5;
        numRows = 3;
    ...
    public ArrayList<Ship> initShips(){
        ...
        for(int row = 0; row < (numRows); row++){
            for(int collum = 0; collum < (numCollumns); collum++){
                ...
                ships.add(new Ship_Ori((collum + row)%3 + 1, location, (stepX*3)/5, initX_Vel, firingProbibility, row, collum));
            }
        }

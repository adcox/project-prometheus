 ...
 * @version May 23, 2010
 *
 * This includes darts and satellites
 */
public class Ori_Mixed_6 extends Level {

    public Ori_Mixed_6(){
        name = "Crabby Crusaders";
        race = RaceName.ORI;
        numCollumns = 5;
        numRows = 3;
    ...
    public ArrayList<Ship> initShips(){
        ...
        for(int row = 0; row < (numRows); row++){
            for(int collum = 0; collum < (numCollumns); collum++){
                ...
                int type = randy.nextInt(2) + 1;
                ships.add(new Ship_Ori(type, location, (stepX*3)/5, initX_Vel, firingProbibility, row, collum));
            }
        }

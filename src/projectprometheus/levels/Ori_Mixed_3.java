 ...
 * @version May 23, 2010
 *
 * This is all three types of ships, arranged in collumns
 */
public class Ori_Mixed_3 extends Level {
    ...
    public ArrayList<Ship> initShips(){
        ...
        for(int row = 0; row < (numRows); row++){
            for(int collum = 0; collum < (numCollumns); collum++){
                ...
                ships.add(new Ship_Ori((collum + 1)%3 + 1, location, (stepX*3)/5, initX_Vel, firingProbibility, row, collum));
            }
        }

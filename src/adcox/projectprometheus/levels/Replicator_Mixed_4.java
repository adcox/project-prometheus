 ...
 *
 * This level only the first 2 types of ships in random arrangement
 */
public class Replicator_Mixed_4 extends Level {

    public Replicator_Mixed_4(){
        name = "Plentiful Possy";

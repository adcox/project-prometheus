 ...
 */
public class Replicator_Mixed_2 extends Level {

    public Replicator_Mixed_2(){
        name = "Terrible Team";
    ...
    public ArrayList<Ship> initShips(){
        ...
        for(int row = 0; row < (numRows); row++){
            for(int collum = 0; collum < (numCollumns); collum++){
                ...
                ships.add(new Ship_Replicator(3 - row, location, (stepX*3)/5, initX_Vel, firingProbibility, row, collum));
            }
        }

 ...
 */
public class Replicator_Mixed_3 extends Level {

    public Replicator_Mixed_3(){
        name = "Raging Replicators";
    ...
    public ArrayList<Ship> initShips(){
        ...
        for(int row = 0; row < (numRows); row++){
            for(int collum = 0; collum < (numCollumns); collum++){
                ...
                ships.add(new Ship_Replicator(collum%3 + 1, location, (stepX*3)/5, initX_Vel, firingProbibility, row, collum));
            }
        }
